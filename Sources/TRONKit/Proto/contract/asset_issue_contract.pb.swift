...
extension Protocol_AssetIssueContract.FrozenSupply: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase,
    ...
    mutating func decodeMessage(decoder: inout some SwiftProtobuf.Decoder) throws {
        while let fieldNumber = try decoder.nextFieldNumber() {
            ...
            // enabled. https://github.com/apple/swift-protobuf/issues/1034
            switch fieldNumber {
            case 1: try decoder.decodeSingularInt64Field(value: &frozenAmount)
            case 2: try decoder.decodeSingularInt64Field(value: &frozenDays)
            default: break
            }
        }
    }
    ...
    func traverse(visitor: inout some SwiftProtobuf.Visitor) throws {
        if frozenAmount != 0 {
            try visitor.visitSingularInt64Field(value: frozenAmount, fieldNumber: 1)
        }
        if frozenDays != 0 {
            try visitor.visitSingularInt64Field(value: frozenDays, fieldNumber: 2)
        }
        try unknownFields.traverse(visitor: &visitor)
    }
...
extension Protocol_TransferAssetContract: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase,
    ...
    mutating func decodeMessage(decoder: inout some SwiftProtobuf.Decoder) throws {
        while let fieldNumber = try decoder.nextFieldNumber() {
            ...
            // enabled. https://github.com/apple/swift-protobuf/issues/1034
            switch fieldNumber {
            case 1: try decoder.decodeSingularBytesField(value: &assetName)
            case 2: try decoder.decodeSingularBytesField(value: &ownerAddress)
            case 3: try decoder.decodeSingularBytesField(value: &toAddress)
            case 4: try decoder.decodeSingularInt64Field(value: &amount)
            default: break
            }
        }
    }
    ...
    func traverse(visitor: inout some SwiftProtobuf.Visitor) throws {
        if !assetName.isEmpty {
            try visitor.visitSingularBytesField(value: assetName, fieldNumber: 1)
        }
        if !ownerAddress.isEmpty {
            try visitor.visitSingularBytesField(value: ownerAddress, fieldNumber: 2)
        }
        if !toAddress.isEmpty {
            try visitor.visitSingularBytesField(value: toAddress, fieldNumber: 3)
        }
        if amount != 0 {
            try visitor.visitSingularInt64Field(value: amount, fieldNumber: 4)
        }
        try unknownFields.traverse(visitor: &visitor)
    }
...
extension Protocol_UpdateAssetContract: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase,
    ...
    mutating func decodeMessage(decoder: inout some SwiftProtobuf.Decoder) throws {
        while let fieldNumber = try decoder.nextFieldNumber() {
            ...
            switch fieldNumber {
            case 1: try decoder.decodeSingularBytesField(value: &ownerAddress)
            case 2: try decoder.decodeSingularBytesField(value: &description_p)
            case 3: try decoder.decodeSingularBytesField(value: &url)
            case 4: try decoder.decodeSingularInt64Field(value: &newLimit)
            case 5: try decoder.decodeSingularInt64Field(value: &newPublicLimit)
            default: break
            }
        }
    }
    ...
    func traverse(visitor: inout some SwiftProtobuf.Visitor) throws {
        ...
        if !description_p.isEmpty {
            try visitor.visitSingularBytesField(value: description_p, fieldNumber: 2)
        }
        if !url.isEmpty {
            try visitor.visitSingularBytesField(value: url, fieldNumber: 3)
        }
        if newLimit != 0 {
            try visitor.visitSingularInt64Field(value: newLimit, fieldNumber: 4)
        }
        if newPublicLimit != 0 {
            try visitor.visitSingularInt64Field(value: newPublicLimit, fieldNumber: 5)
        }
        try unknownFields.traverse(visitor: &visitor)
    }
...
extension Protocol_ParticipateAssetIssueContract: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase,
    ...
    mutating func decodeMessage(decoder: inout some SwiftProtobuf.Decoder) throws {
        while let fieldNumber = try decoder.nextFieldNumber() {
            ...
            case 3: try decoder.decodeSingularBytesField(value: &assetName)
            case 4: try decoder.decodeSingularInt64Field(value: &amount)
            default: break
            }
        }
    ...
    func traverse(visitor: inout some SwiftProtobuf.Visitor) throws {
        ...
        if !assetName.isEmpty {
            try visitor.visitSingularBytesField(value: assetName, fieldNumber: 3)
        }
        if amount != 0 {
            try visitor.visitSingularInt64Field(value: amount, fieldNumber: 4)
        }
