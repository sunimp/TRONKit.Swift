...
class ReceiveController: UIViewController {
    override func viewDidLoad() {
        ...
        addressLabel.text = Manager.shared.adapter.receiveAddress.base58
    ...
    @objc private func copyToClipboard() {
        UIPasteboard.general.string = Manager.shared.adapter.receiveAddress.base58
        print(Manager.shared.adapter.receiveAddress.base58)
